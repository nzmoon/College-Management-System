...
<table width="100%">
	...
	<tr class="resultspage">
		...
		<div class="col-md-5">
		<td align="right">
<img src="images/govlogo.png" width="130" height="120" alt="Logo" />
...
<tr><td> Student Informantion </td>
<td class="stimages" colspan="2" >
	...
	if(trim($row["image"])!="")
	{
			...
			{
				$img_patd = '<img src="'.$image_dir.$img_name.'" height="300" width="300"/>';
			}
			else
			{
