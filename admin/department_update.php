...
<tr><td width="23%"> DEPARTMENT </td><td width="2%">:</td><td width="75%">
 ...
 <option value="COMPUTER" <?php if(trim($row["department_name"]) =='COMPUTER') echo 'selected';?>> COMPUTER </option>
 <option value="CONSTRUCTION" <?php if(trim($row["department_name"]) =='CONSTRUCTION') echo 'selected';?>> CONSTRUCTION </option>
  <option value="ELECTICAL" <?php if(trim($row["department_name"]) =='ELECTICAL') echo 'selected';?>> ELECTICAL </option>
    <option value="MECHANICAL" <?php if(trim($row["department_name"]) =='MECHANICAL') echo 'selected';?>> MECHANICAL </option>
 <option value="CIVIL" <?php if(trim($row["department_name"]) =='CIVIL') echo 'selected';?>> CIVIL </option>
  <option value="AUTOMOBILE" <?php if(trim($row["department_name"]) =='AUTOMOBILE') echo 'selected';?>> AUTOMOBILE </option>
    <option value="SWEDISH" <?php if(trim($row["department_name"]) =='SWEDISH') echo 'selected';?>> SWEDISH </option>
	
	 <option value="JAHANGIR" <?php if(trim($row["department_name"]) =='JAHANGIR') echo 'selected';?>> JAHANGIR </option>
  <option value="LADISH_HOSTEL" <?php if(trim($row["department_name"]) =='LADISH_HOSTEL') echo 'selected';?>> LADISH HOSTEL </option>
    <option value="SPORTS" <?php if(trim($row["department_name"]) =='SPORTS') echo 'selected';?>> SPORTS </option>
	
	  <option value="TEACHERS_RESIDENCE" <?php if(trim($row["department_name"]) =='TEACHERS_RESIDENCE') echo 'selected';?>> TEACHERS RESIDENCE </option>
    <option value="DAINING" <?php if(trim($row["department_name"]) =='DAINING') echo 'selected';?>> DAINING </option>
	 <option value="MOSQUE" <?php if(trim($row["department_name"]) =='MOSQUE') echo 'selected';?>> MOSQUE </option>
